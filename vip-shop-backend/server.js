...
if (!SUPABASE_URL || !SUPABASE_SERVICE_ROLE_KEY) {
  console.error('‘ÿÓ Fehler: SUPABASE_URL und SUPABASE_SERVICE_ROLE_KEY m++ssen gesetzt sein!');
  process.exit(1);
}

if (!RECAPTCHA_SECRET_KEY) {
  console.error('‘ÿÓ Fehler: RECAPTCHA_SECRET_KEY muss gesetzt sein!');
  process.exit(1);
}
...
const initializeDatabase = async () => {
  try {
    ...
    console.log('‘£Ù Supabase Datenbank initialisiert');
  } catch (error) {
...
const authenticateAdmin = (req, res, next) => {
  ...
  if (!adminSecret || adminSecret !== ADMIN_SECRET) {
    console.log('[DEBUG Auth] ‘ÿÓ Authentication failed');
    return res.status(401).json({ error: 'Unauthorized' });
  }
  
  console.log('[DEBUG Auth] ‘£Ù Authentication successful');
  next();
};
...
app.post('/order', async (req, res) => {
  try {
    ...
    // Pr++fe ob Code bereits verwendet wurde
...
// 1.5 POST /verify-code - Verifikationscode ++berpr++fen
...
app.get('/admin/orders', authenticateAdmin, async (req, res) => {
  try {
    ...
    // Wenn status Parameter ++bergeben wird, filtern
    if (status) {
...
// 5. POST /admin/finish/:id - Bestellung als "finished" markieren (Code wird g++ltig)
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      console.log(`
‘Úˆ‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú˘
‘ÚÊ    VIP SHOP BACKEND - ONLINE       ‘ÚÊ
‘Ú·‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú˙
‘ÚÊ Server l+Òuft auf Port ${PORT}         ‘ÚÊ
‘ÚÊ Datenbank: Supabase                ‘ÚÊ
‘ÚÊ Mode: ${process.env.NODE_ENV}        ‘ÚÊ
‘Ú‹‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Ú…‘Úÿ
      `);
